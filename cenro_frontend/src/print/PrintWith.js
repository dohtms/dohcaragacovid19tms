...
const PrintWidth = React.forwardRef((props, ref) => {
    ...
    useEffect(() => {
        ...
        // console.log(monthArr[datess.getMonth()])
        // setBxuM(datess.getMonth())
        setDoneDate({
            ...doneDate,
    ...
    return (
        <Box ref={ref} sx={{ width: '787.2px', height: '99%', overflow: 'hidden', m: 0, p: 0, pt: '48px' }}>
            ...
            <div style={{ margin: 0, padding: '0px 96px', paddingBottom: '48px' }}>
                <div style={{ width: '100%', borderBottom: '2px solid black', marginBottom: '10px', borderColor: 'green' }}></div>
                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                    <p style={{ padding: 0, margin: 0, fontSize: '16px', fontFamily: 'Lucida Calligraphy', lineHeight: '18px' }}><b>ENVIRONMENTAL CLEARANCE</b></p>
                    <p style={{ padding: 0, margin: 0, fontSize: '14px', color: 'green', lineHeight: '18px' }}>WITH ENVIRONMENTAL IMPACT</p>
                ...
                <div>
                    ...
                    <p style={{ padding: 0, margin: 0, fontSize: '13px', marginBottom: '15px', fontFamily: 'Century Gothic', textAlign: 'justify', textIndent: '30px' }}>
                    ...
                    <p style={{ padding: 0, margin: 0, fontSize: '13px', textIndent: '25px', fontFamily: 'Century Gothic', textAlign: 'justify', marginBottom: '15px' }}>
                        Thus, this is to certify that the aforementioned business/project has potential adverse environmental impact and strictly require to secure Environmental
                        Compliance Certificate (ECC)/Certificate of Non-Coverage (CNC) and oblige the proponent to implement mitigating measures as provided therein.
                    </p>
                    <p style={{ padding: 0, margin: 0, fontSize: '13px', textIndent: '10px', marginBottom: '15px', fontFamily: 'Century Gothic', textAlign: 'justify' }}>
                    ...
                    <div style={{ display: 'flex' }}>
                        ...
                        <div style={{ width: '97%', paddingLeft: '5px' }}>
                            <p style={{ padding: 0, margin: 0, fontSize: '13px', marginBottom: '15px', fontFamily: 'Century Gothic' }}>
                                Compliance to <b>SP Ordinance 5334-2017</b> "An Ordinance regulating the use of plastics by-products in Butuan City, prescribing penalties for violation thereof, repealing for this purpose <b>SP Ordinance 5064-2016</b>,
                    ...
                    <p style={{ padding: 0, margin: 0, fontSize: '13px', marginBottom: '15px', fontFamily: 'Century Gothic', textAlign: 'justify', textIndent: '30px' }}>
                        ...
                        otherwise known as the "<b>Butuan City Environmental Code</b>".
                    </p>
                    <p style={{ padding: 0, margin: 0, fontSize: '13px', textIndent: '30px', marginBottom: '15px', fontFamily: 'Century Gothic' }}>
